        ...
        <div>
            <div id="menuToggle" className="inline-block p-3 bg-gray-200">
                ...
                <div className="loginRegister inline-block float-right sm:text-xs md:text-lg">
                    <button className="rounded-md font-medium text-blue-500 hover:text-white bg-white hover:bg-blue-500 border-2 border-blue-500 m-3">Register</button>
                    <button className="rounded-md font-medium text-green-500 hover:text-white bg-white hover:bg-green-500 border-2 border-green-500 m-3">Login</button>
                </div>
            </div>
        </div>
    )
